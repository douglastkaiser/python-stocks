...
class TestMathHelper(unittest.TestCase):
    ...
    def test_slope(self):
        # Single elements.
        self.assertEqual(0, slope(0))
        self.assertEqual(0, slope(1.5))
        # Single element vectors.
        self.assertEqual(0, slope([1.5]))
        # Multiple element vectors. Positive slope.
        self.assertEqual(1, slope([2, 3]))
        self.assertEqual(-1, slope([3, 2]))
        self.assertEqual(0, slope([2, 2]))

    # def test_slope_vectorized(self):
    #     slope_vectorized(data, n)

    # def test_curvature(self):
    #     curvature(data, n)

    # def test_curvature_vectorized(self):
    #     curvature_vectorized(data, n)
